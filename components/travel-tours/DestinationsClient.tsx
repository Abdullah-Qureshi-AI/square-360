...
export function DestinationsClient({ tours }: { tours: TravelTour[] }) {
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl">
        ...
        <p className="mt-3 text-slate-300 font-light leading-relaxed">
          These are the tours currently open and running. Pick one to proceed, or build a custom
            ...
            <div className="p-5">
              <div className="flex items-start justify-between gap-4">
                <div className="min-w-0">
                  ...
                  <h2 className="mt-2 text-lg font-semibold text-white leading-snug">{tour.title}</h2>
                  <p className="mt-1 text-sm text-slate-300">{tour.destination}</p>
                </div>
                <div className="shrink-0">
                  <span className="inline-flex items-center rounded-full bg-amber-500/15 text-amber-300 px-3 py-1 text-xs font-semibold border border-amber-500/25">
                    {tour.status === "active" ? "Proceeding" : tour.status}
                  </span>
                </div>
              </div>
              ...
              <div className="mt-4">
                <div className="text-[10px] uppercase tracking-wider text-slate-400 mb-2">Highlights</div>
